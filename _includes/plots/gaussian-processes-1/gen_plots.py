...
def plot_unit_gaussian_samples(D):
    p = figure(plot_width=800, plot_height=500, title='Samples from a unit {}D Gaussian'.format(D), sizing_mode='scale_width', tools='pan, wheel_zoom, box_zoom, reset', active_drag=None)
...
p = figure(plot_width=400, plot_height=400, x_range=(-2, 2), y_range=(-2, 2),
           title='Visualisation of k(x, x\')', x_axis_label='x', y_axis_label='x\'', toolbar_location=None, sizing_mode='scale_width', tools='pan, wheel_zoom, box_zoom, reset', active_drag=None)
...
p = figure(plot_width=800, plot_height=500, title='Samples from a 20D Gaussian with kernel smoothing', sizing_mode='scale_width', tools='pan, wheel_zoom, box_zoom, reset', active_drag=None)
D = 20
xs = np.linspace(0, 1, D)
for color in Category10[10]:
...
p = figure(plot_width=800, plot_height=500, title='5 samples from GP prior', sizing_mode='scale_width', tools='pan, wheel_zoom, box_zoom, reset', active_drag=None)
...
p = figure(plot_width=800, plot_height=400, x_axis_label='x', y_axis_label='f(x)',
           title='The hidden function f(x)', sizing_mode='scale_width', tools='pan, wheel_zoom, box_zoom, reset', active_drag=None)
...
p = figure(plot_width=800, plot_height=600, y_range=(-7, 8), title='GP posterior', sizing_mode='scale_width', tools='pan, wheel_zoom, box_zoom, reset', active_drag=None)
